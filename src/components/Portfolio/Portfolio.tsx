...
const projects = [
  ...
  },
  {
    title: 'KF2 ESMA',
    description:
      'A simple program that converts a collection of Killing Floor 2 steam workshop maps and outputs the server configs to import custom maps into a server.',
  ...
  },
  {
    title: 'ASLearner',
    description:
      'An American Sign Language Learning app. It provides a simple and intuitive interface for learning ASL through interactive lessons, quizzes, and practice exercises. The app is designed to be accessible and user-friendly, making it easy for anyone to start learning ASL.',
  ...
  },
  {
    title: 'WiktionaryViz',
    description:
      'An explorative visual analytics tool for linguistics based upon Wiktionary data. It allows users to explore and analyze linguistic data in an interactive way, providing insights into word usage, definitions, and relationships.',
...
const Portfolio: React.FC = () => {
  ...
  return (
    <section
      ...
      className="relative flex min-h-screen flex-col items-center justify-center overflow-visible px-0 py-16"
    >
      <ParallaxBackground />
      <motion.h2
        ...
        className="sticky top-0 z-10 mb-8 py-4 text-center text-3xl font-bold"
      ...
      <div ref={containerRef} className="relative flex w-full flex-col">
        {projects.map((project, index) => (
          <motion.div
            key={project.title}
            className={`sticky top-[3vh] mx-auto w-full max-w-3xl shrink-0 z-${index === activeIndex ? '50' : '10'}`}
