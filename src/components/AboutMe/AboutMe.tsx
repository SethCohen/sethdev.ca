...
const techStack = {
  languages: [
    ...
    { icon: <JavaIcon className="h-6 w-6" />, label: 'Java', isSimpleIcon: false },
    ...
    { icon: <SqlIcon className="h-6 w-6" />, label: 'SQL', isSimpleIcon: false },
  ...
  dataml: [
    ...
    { icon: <MatplotlibIcon className="h-6 w-6" />, label: 'Matplotlib', isSimpleIcon: false },
    { icon: <SeabornIcon className="h-6 w-6" />, label: 'Seaborn', isSimpleIcon: false },
  ...
  creative: [
    ...
    {
      icon: <AdobeIllustratorIcon className="h-6 w-6" />,
      label: 'Adobe Illustrator',
      isSimpleIcon: false,
    },
    {
      icon: <AdobePremiereProIcon className="h-6 w-6" />,
      label: 'Adobe Premiere Pro',
      isSimpleIcon: false,
    },
    {
      icon: <AdobeAfterEffectsIcon className="h-6 w-6" />,
    ...
    { icon: <VSCodeIcon className="h-6 w-6" />, label: 'VS Code', isSimpleIcon: false },
    { icon: <VisualStudioIcon className="h-6 w-6" />, label: 'Visual Studio', isSimpleIcon: false },
  ],
  databases: [
...
const languages = [
  {
    flag: <CanadaFlag className="mb-1 inline-block h-8 w-8" />,
    name: 'English',
    level: 'Fluent (Native)',
    clb: 'CLB 9 / CEFR C2',
  ...
  {
    flag: <MexicoFlag className="mb-1 inline-block h-8 w-8" />,
    name: 'Spanish',
    level: 'Intermediate (CLB 5 / CEFR B1)',
    clb: '',
    color: 'text-amber-400',
  },
  {
    flag: <FranceFlag className="mb-1 inline-block h-8 w-8" />,
    name: 'French',
    level: 'Low Intermediate (CLB 4 / CEFR A2)',
    clb: '',
    color: 'text-amber-400',
  },
  {
    flag: <ASLFlag className="mb-1 inline-block h-8 w-8" />,
    name: 'ASL',
    level: 'Low Intermediate (CLB 3 / CEFR A2)',
    clb: '',
    color: 'text-amber-400',
  },
  {
    flag: <IranFlag className="mb-1 inline-block h-8 w-8" />,
    name: 'Farsi',
    level: 'Beginner (CLB 2 / CEFR A1)',
    clb: '',
    color: 'text-amber-400',
  },
  {
    flag: <GermanFlag className="mb-1 inline-block h-8 w-8" />,
    name: 'German',
    level: 'Beginner (CLB 1 / CEFR A1)',
    clb: '',
    color: 'text-amber-400',
  },
]
...
const aboutParagraphs = [
  ...
  },
  {
    ...
    keywords: ['user', 'seamless', 'inclusive', 'curiosity', 'learning', 'exploration'],
  },
  {
...
const headingClass =
  'text-amber-400 not-last:mb-8 text-4xl md:text-5xl font-extrabold tracking-tight'
              ...
              {Object.entries(techStack).map(([category, items]) => (
                <div className={techSectionClass} key={category}>
                  ...
                  <div className={techIconRow}>
                    {(
                      items as Array<{
                        icon: React.ReactNode | { path: string; hex: string } | null
                        label: string
                        isSimpleIcon: boolean
                      }>
                    ).map(({ icon, label, isSimpleIcon }) => (
                      <Tooltip key={label}>
